...
public class CuentaDAO implements ICuentaDAO {
    ...
    public Cuenta readFromAlias(String alias) throws DAOException {
        ...
        try {
            ...
            Connection con5 = DriverManager.getConnection("jdbc:h2:/Users/valentinaborras/Desktop/Lic.EnIA/LabI(java)/DB", "valen", "123");
            Statement statement5 = con5.createStatement();
            ResultSet resultSet2 = statement5.executeQuery("SELECT * FROM CUENTA WHERE ALIAS= " + "'" +alias +"'");
    ...
    public void depositar(Cuenta cuenta, double monto) throws DAOException {
        try {
            ...
            int cantRegistros2 = statement3.executeUpdate("UPDATE CUENTA SET BALANCE = '" + nuevoBalance + "' WHERE IDCUENTA=" + cuenta.getIdCuenta());
            if(cantRegistros2 > 0)
                System.out.println("Se modificó la cuenta");
